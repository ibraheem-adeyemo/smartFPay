...
import ViewSingleBatchCustomer from "../../ViewSingleBatchCustomer";

const BatchCustomersTable = memo(
  ({ dataState, fetchData, permissions, history, location, batchId }) => {
    ...
    return (
      <Col md={12} lg={12}>
        ...
        <ModalComponent isOpen={showModal} toggle={toggleModal} size="lg">
          <ViewSingleBatchCustomer isModal selectedCustomer={selectedRow} />
        </ModalComponent>
      </Col>
    );
  }
